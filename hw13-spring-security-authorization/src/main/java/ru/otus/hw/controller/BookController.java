...
public class BookController {
    ...
    public String insertBook(@Valid @ModelAttribute("book") BookUpdateDto bookUpdateDto,
        ...
        BookDto savedBook = bookService.insert(bookUpdateDto.getTitle(), bookUpdateDto.getAuthorId(),
                                                                                            bookUpdateDto.getGenreId());
        aclServiceWrapperService.createPermission(bookDtoConverter.toDomain(savedBook), BasePermission.READ);
